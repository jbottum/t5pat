...
Of the 17 questions, both models answered scored under 50%.  The Large answered (6) correctly and XL answered (8) correctly.  The XL was stronger on knowledge retreival, cause and effect, deductive and inductive reasoning.  The XL did not perform well on analogical or counterfactual questions.   Neither model did a good job with prompts that contained two questions and both models mostly answered the second question and ignored the 1st question.  It is important to note that the XL model takes longer to load and run, and there is a delay between when the Large model's output completes and the XL model's output starts.
